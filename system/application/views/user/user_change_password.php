...
$(document).ready(function() {
	...
	function check_current_pass(current_pass){
		...
		$.ajax({
			type: 'POST',
			url: base_url+'main/home/password_validation/user',
...
<form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>main/user/update_password" id="user_password_form" name="user_password_form" class="form-horizontal" autocomplete="off" >

    <input id="action" name="action" type="hidden" value="user_password_form" />
