...
<div class="row-fluid"> <!--Body content start-->
    ...
    <div class="span9 bgwhite"> <!--Body Left content start-->
        ...
        <form method="post" enctype="multipart/form-data"  class="form-verticle" autocomplete="off" id="quiz_form" name="quiz_form" action="<?php echo base_url();?>main/grader/save_homework_feedback">
		...
		?>
			...
			<input id="tid[]" name="tid[]" type="hidden" value="<?php echo $row['type_id']; ?>" />
                        <div class="control-group">
                                ...
                                <?php if($row['type_id']=="1"){ ?>
                                	...
                                	<?php foreach ($answers as $option) { ?>
                                                <textarea id="question_<?php echo $i; ?>" class="input-xxlarge" name="question[]" placeholder="<?php echo $option['answer']; ?>" readonly="readonly" rows="4"><?php echo $option['answer']; ?></textarea>
                                        <?php } ?>
					...
					$options = explode(",", $option['option_name']);
                        ...
                        <div class="control-group form-verticle">
                                <label class="control-label">Comments:</label>
                                <div class="controls">
                                        <textarea class="textfield input-xxlarge required" name="comments[]" rows="3" ></textarea>
                ...
                <div class="control-group">
                        ...
                        <div class="controls">
                                <select name="grade" class="input-xxlarge" id="grade">
            ...
            <div class="control-group form-horizontal pull-right">
                ...
                <div class="controls">
                        <button id="btn-save" class="btn btn-success" name="submit" type="submit">Submit</button>
                </div>
            </div>
