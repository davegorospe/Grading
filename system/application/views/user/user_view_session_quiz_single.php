		...
		?>
					...
					$options = explode(",", $option['option_name']);
                        ...
                        <div class="control-group form-verticle">
                                ...
                                <div class="controls">
	                                <p class="triangle-border top"><?php echo $option['remarks']; ?>.</p>
            ...
            <div class="control-group form-horizontal">
                <label class="control-label">&nbsp;</label>
                <div class="controls">
                        <button id="btn-save" class="btn btn-success hidden" name="submit" type="button" disabled="disabled">Submit</button>
                </div>
            </div>
