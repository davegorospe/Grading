    ...
    <div class="span9 bgwhite"> <!--Body Left content start-->
    	 ...
    	 <div class="row-fluid">
            <div class="span12 heading-left">
                <!--Body content-->
                <h3>Resume Quiz Session: <?php echo $title; ?></h3>
            </div>
        </div>
        
        <div class="clearfix"></div>
        
        <form method="post" enctype="multipart/form-data"  class="form-horizontal" autocomplete="off" id="quiz_form" name="quiz_form" action="<?php echo base_url();?>main/user/update_session_quiz">
		...
		?>
                	<input id="aqid[]" name="aqid[]" type="hidden" value="<?php echo $row['qid']; ?>" />
                        ...
                        <div class="control-group">
                                ...
                                <?php if($row['type_id']=="1"){ ?>
                                	...
                                	<?php foreach ($answers as $option) { ?>
                                                <input id="question_<?php echo $i; ?>" class="input-xlarge required" name="question[]" type="text" value="<?php echo $option['answer']; ?>" placeholder="<?php echo $row['question']; ?>" />
                                        <?php } ?>
