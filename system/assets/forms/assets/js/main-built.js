...
(function (e, t) {
	...
	ut.fn = ut.prototype = {
		...
		map: function (e, t, r) {
			var i, s = 0,
				...
				u = n(e),
				a = [];
			if (u) for (; o > s; s++) i = t(e[s], s, r), null != i && (a[a.length] = i);
		...
		if (!V) if (V = ut.Deferred(), "complete" === $.readyState) setTimeout(ut.ready);
	...
	ut.fn.extend({
		...
		toggleClass: function (e, t) {
			...
			return ut.isFunction(e) ? this.each(function (n) {
				...
				if ("string" === n) for (var i, s = 0, o = ut(this), u = t, a = e.match(ft) || []; i = a[s++];) u = r ? u : !o.hasClass(i), o[u ? "addClass" : "removeClass"](i);
	...
	ut.event = {
		...
		dispatch: function (e) {
			...
			if (a[0] = e, e.delegateTarget = this, !l.preDispatch || l.preDispatch.call(this, e) !== !1) {
				...
				(s = u[n++]) && !e.isPropagationStopped();) for (e.currentTarget = s.elem, r = 0;
	...
	function (e, t, n) {
		...
		function g(e) {
			...
			}]; i > u; u++) if (n = T.relative[e[u].type]) l = [p(d(l), n)];
			else {
		...
		C = o.isXML = function (e) {
			...
			}), P = RegExp(P.join("|")), H = RegExp(H.join("|")), j = n(_.contains) || _.compareDocumentPosition ?
			function (e, t) {
	...
	sn.optgroup = sn.option, sn.tbody = sn.tfoot = sn.colgroup = sn.caption = sn.thead, sn.th = sn.td, ut.fn.extend({
		...
		clone: function (e, t, n) {
			...
			if (t) if (n) for (i = i || b(e), r = r || b(u), o = 0; null != (s = i[o]); o++) g(s, r[o]);
			else g(e, u);
			return r = b(u, "script"), r.length > 0 && m(r, !a && b(e, "script")), r = i = s = null, u
		},
		buildFragment: function (e, t, n, r) {
			for (var i, s, o, u, a, f, l, c = e.length, p = h(t), d = [], v = 0; c > v; v++) if (s = e[v], s || 0 === s) if ("object" === ut.type(s)) ut.merge(d, s.nodeType ? [s] : s);
			else if (Gt.test(s)) {
	...
	return n.Model.extend({
		getValues: function () {
			return t.reduce(this.get("fields"), function (e, t, n) {
	...
	return '\n'
	//return '<!-- Prepended text-->\n<div class="control-group">\n  <label class="control-label"><%= label %></label>\n  <div class="controls">\n    <div class="input-prepend">\n      <span class="add-on"><%= prepend %></span>\n      <input id="<%= id %>" name="<%= id %>" class="span2" placeholder="<%= placeholder %>" type="text"<% if(required) {%> required <% } %> />\n    </div>\n    <% if (helptext.length > 0) { %><p class="help-block"><%= helptext %></p><% } %>\n  </div>\n</div>\n'
}), define("text!templates/snippet/searchinput.html", [], function () {
	return '\n'
	//return '<!-- Search input-->\n<div class="control-group">\n  <label class="control-label"><%= label %></label>\n  <div class="controls">\n    <input id="<%= id %>" name="<%= id %>" type="text" placeholder="<%= placeholder %>" class="input-xlarge search-query" <% if(required) {%> required <% } %> />\n    <% if (helptext.length > 0) { %><p class="help-block"><%= helptext %></p><% } %>\n  </div>\n</div>\n'
}), define("text!templates/snippet/textinput.html", [], function () {
	return '<!-- Text input-->\n<div class="control-group">\n  <label class="control-label"><%= label %></label>\n  <div class="controls">\n    <input id="<%= id %>" name="<%= id %>" type="text" placeholder="<%= placeholder %>" class="input-xlarge" <% if(required) {%> required <% } %> />\n    <% if (helptext.length > 0) { %><p class="help-block"><%= helptext %></p><% } %>\n  </div>\n</div>\n'
	...
	return '<!-- Button -->\n<div class="control-group">\n  <label class="control-label"><%= label %></label>\n  <div class="controls">\n    <button id="<%= id %>" name="<%= id %>" class=\'btn <%= _.find(buttontype, function(o){return o.selected})["value"] %>\'><%= buttonlabel %></button>\n  </div>\n</div>\n'
}), define("text!templates/snippet/buttondouble.html", [], function () {
	return '\n'
	//return '<!-- Button (Double) -->\n<div class="control-group">\n  <label class="control-label"><%= label %></label>\n  <div class="controls">\n    <button id="<%= id %>" name="<%= id %>" class=\'btn <%= _.find(button1type, function(o){return o.selected})["value"] %>\'><%= button1label %></button>\n    <button id="<%= id2 %>" name="<%= id2 %>" class=\'btn <%= _.find(button2type, function(o){return o.selected})["value"] %>\'><%= button2label %></button>\n  </div>\n</div>\n'
	...
	return '\n'
	//return '<!-- Password input-->\n<div class="control-group">\n  <label class="control-label"><%= label %></label>\n  <div class="controls">\n    <input id="<%= id %>" name="<%= id %>" type="password" placeholder="<%= placeholder %>" class="input-xlarge" <% if(required) {%> required <% } %> />\n    <% if (helptext.length > 0) { %><p class="help-block"><%= helptext %></p><% } %>\n  </div>\n</div>\n'
	...
	return '<!-- Select Basic -->\n<div class="control-group">\n  <label class="control-label"><%= label %></label>\n  <div class="controls">\n    <select id="<%= id %>" name="<%= id %>" class="input-xlarge"><% _.each(options, function(option) { %>\n      <option><%= option %></option><% }); %>\n    </select>\n  </div>\n</div>\n'
}), define("text!templates/snippet/selectmultiple.html", [], function () {
	return '\n'
	//return '<!-- Select Multiple -->\n<div class="control-group">\n  <label class="control-label"><%= label %></label>\n  <div class="controls">\n    <select id="<%= id %>" name="<%= id %>" class="input-xlarge" multiple="multiple"><% _.each(options, function(option) { %>\n      <option><%= option %></option><% }); %>\n    </select>\n  </div>\n</div>\n'
...
function (e) {
	...
	return n.View.extend({
		...
		render: function () {
			...
			n.collection !== undefined ? t.each(this.collection.renderAll(), function (e) {
				n.$el.append(e)
			}) : n.options.content && n.$el.append(n.options.content), e(".nav.nav-tabs").append(this.tabNavTemplate({
	...
	return {
		initialize: function () {
			...
			}), new s({title:"Rendered",content:c}),/*new s({title:"About",content:h}),*/
			e(".tab-pane").first().addClass("active"), e("ul.nav li").first().addClass("active"), new o({
				title: "Original",
				collection: new i([{
					title: "Form Name",
					fields: {
